...
VALUES
  (1, 'Inception', 'A mind-bending thriller about dreams within dreams.', 148, 'PG-13', b'1', '2010-07-16', 'https://m.media-amazon.com/images/M/MV5BMjAxMzY3NjcxNF5BMl5BanBnXkFtZTcwNTI5OTM0Mw@@._V1_.jpg', 'https://www.youtube.com/watch?v=YoHD9XEInc0', 'Released', 8.8),
  (2, 'The Dark Knight', 'Batman faces the Joker in this gritty action film.', 152, 'PG-13', b'0', '2008-07-18', 'https://m.media-amazon.com/images/M/MV5BMTMxNTMwODM0NF5BMl5BanBnXkFtZTcwODAyMTk2Mw@@._V1_FMjpg_UX1000_.jpg', 'https://www.youtube.com/watch?v=EXeTwQWrcwY', 'Released', 9.0),
  (3, 'Once Upon a Time in Hollywood', 'A faded actor and his stunt double navigate 1969 Hollywood.', 161, 'R', b'1', '2019-07-26', 'https://m.media-amazon.com/images/M/MV5BN2IwMmVmOTktMWNiMi00NjFiLThlZDUtMDAyOGZiNmJjM2ExXkEyXkFqcGc@._V1_.jpg', 'https://www.youtube.com/watch?v=ELeMaP8EPAA', 'Released', 7.6);

-- INSERTs para tabla movie_genres
...
-- INSERTs para tabla movie_formats
...
-- INSERTs para tabla movie_directors (adaptado a la tabla: directed_movies_id, directors_id)
INSERT INTO movie_directors (directed_movies_id, directors_id)
VALUES
  (1, 1),  -- Inception → Nolan
  (2, 1),  -- The Dark Knight → Nolan
  (3, 2);  -- Once Upon → Tarantino

-- INSERTs para tabla movie_actors (adaptado a la tabla: movies_id, actors_id)
